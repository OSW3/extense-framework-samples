...
// console.log( browser.runtime.getManifest().default_locale );
// console.log( browser.runtime.getManifest().current_locale );

function getEngine() {
    return browser || chrome;
};

// function getEngineNName() {
//     try {
//         browser;
//         return "browser";
//     } catch(e) {
